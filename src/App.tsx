...
const testimonials = [
  ...
  { quote: "Kristine's creativity is truly impressive. She's incredibly talented, resourceful, and adaptable. It's hard to believe she's self-taught, given the professionalism and quality of her work. Everything she creates aligns perfectly with our business goals and branding.", name: "Jeff Wilson", role: "Soundtrace CEO" },
  { quote: "Wonderful doesn't even begin to cover it—Kristine was a cornerstone of our team's success. She is one of those rare colleagues you can always count on, no matter the deadline. Her drive and timeliness are matched only by her kindness and organizational spirit. Kristine tackled every challenge with a tenacious attitude that was truly inspiring to witness. She doesn't just get the job done; she cares deeply about the quality of the work. I'd jump at the chance to collaborate with her again in the future!", name: "Sabrina Kumar", role: "Account Executive" },
];
